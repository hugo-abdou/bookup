		...
		<template #form>
			...
			<div class="col-span-6 sm:col-span-3">
				...
				<jet-input
					...
					:error="form.errors.password && form.errors.password.includes('confirmation')"
					autocomplete="new-password"
				/>
				<jet-input-error
					:message="form.errors.password && form.errors.password.includes('confirmation') && form.errors.password"
					class="mt-2"
				/>
			</div>
		</template>
